...
from agents.config import MAX_LOOP_ITERATIONS, VERBOSE
from agents.core.agent import Agent
from agents.core.agent_registry import agents_available_to, get_agent
...
from agents.core.results import AgentResponse, HandoverRequest
from agents.core.tool_registry import call_tool, get_tools
...
def run_agent(
    ...
    *depth* guards against infinite handover recursion.
    ...
    if depth == 0:
        ...
        from agents.core.runtime import current_runtime, Runtime
